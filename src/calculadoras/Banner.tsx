...
function Banner({ volverMenu }: Props) {
  const [descripcion, setDescripcion] = useState("Banner 4m x 0.5m");
  const [costoProveedor, setCostoProveedor] = useState(24);
  ...
  return (
    <div className="calculadora">
      ...
      <p className="subtitulo">
        Calcula banners usando el costo real que te da el proveedor.
      </p>
      ...
      <div className="consejo">
        ...
        <p>
          Usa el precio exacto que te da tu proveedor. Luego suma diseño,
          transporte, instalación y extras para obtener un precio rentable.
        </p>
      </div>
    </div>
  );
