  ...
  return (
    <div className="calculadora">
      ...
      <div className="consejo">
        ...
        <p>
          Utiliza el precio real que te da tu proveedor y agrega diseño,
          instalación, transporte y extras para obtener una cotización rentable.
        </p>
      </div>
    </div>
  );
